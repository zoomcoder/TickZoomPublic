...
namespace TickZoom.LimeQuotes
{
    ...
    public class MessageLimeQuotesNotUsed : Message
    {
        private static readonly Log log = Factory.SysLog.GetLogger(typeof(MessageLimeQuotesNotUsed));
        ...
        public MessageLimeQuotesNotUsed()
        {
        ...
        //UNDONE: Need to redo for Lime Quotes
