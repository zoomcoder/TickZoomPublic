...
{
    public class FIXFactory4_2 : FIXTFactory1_1
    {
        public static readonly string FIXVersion = "FIX.4.2";

        public FIXFactory4_2(int nextSequence, string sender, string destination) :
            base(FIXVersion, nextSequence, sender, destination)
        {
        ...
        {
            var message = new FIXMessage4_2(Sender, Destination);
    ...
    //UNDONE: Remove non 4.2 Fix types
    public class FIXMessage4_2 : FIXTMessage1_1
    {
        private string executionType;
        protected string orderStatus;
        private string symbol;

        internal FIXMessage4_2(string sender, string destination)
            : base(FIXFactory4_2.FIXVersion, sender, destination)
        {
        }
