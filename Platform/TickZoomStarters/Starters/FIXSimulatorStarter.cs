...
namespace TickZoom.Starters
{
    public class FIXSimulatorStarter : RealTimeStarterBase
    {
		...
		public override void Run(ModelLoaderInterface loader)
		{
            ...
            using (Factory.Parallel.SpawnProvider("MBTFIXProvider", "MBTFIXSimulator", "Simulate", ProjectProperties.Starter.PartialFillSimulation, ProjectProperties.Starter.EndTime))
            { 
				base.Run(loader);
			}
